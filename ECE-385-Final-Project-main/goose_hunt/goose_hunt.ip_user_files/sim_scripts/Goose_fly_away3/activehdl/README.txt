...
#
# Generated by export_simulation on Mon Apr 29 18:41:01 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './Goose_fly_away3.sh' script.

./Goose_fly_away3.sh -reset_run
...
./Goose_fly_away3.sh -noclean_files

For more information on the script, please type './Goose_fly_away3.sh -help'.

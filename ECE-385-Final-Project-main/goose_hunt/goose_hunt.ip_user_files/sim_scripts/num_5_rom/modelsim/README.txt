...
#
# Generated by export_simulation on Thu May 02 09:57:10 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_5_rom.sh' script.

./num_5_rom.sh -reset_run
...
./num_5_rom.sh -noclean_files

For more information on the script, please type './num_5_rom.sh -help'.

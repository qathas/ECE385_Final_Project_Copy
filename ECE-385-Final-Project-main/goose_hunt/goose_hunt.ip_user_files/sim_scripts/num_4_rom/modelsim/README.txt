...
#
# Generated by export_simulation on Thu May 02 09:56:38 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_4_rom.sh' script.

./num_4_rom.sh -reset_run
...
./num_4_rom.sh -noclean_files

For more information on the script, please type './num_4_rom.sh -help'.

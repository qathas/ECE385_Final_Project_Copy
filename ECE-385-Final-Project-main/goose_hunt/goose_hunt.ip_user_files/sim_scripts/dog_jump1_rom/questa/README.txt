...
#
# Generated by export_simulation on Fri Apr 26 09:10:04 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './dog_jump1_rom.sh' script.

./dog_jump1_rom.sh -reset_run
...
./dog_jump1_rom.sh -noclean_files

For more information on the script, please type './dog_jump1_rom.sh -help'.

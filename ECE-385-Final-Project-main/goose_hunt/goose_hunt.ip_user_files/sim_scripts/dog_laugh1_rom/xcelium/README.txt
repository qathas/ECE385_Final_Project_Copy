...
#
# Generated by export_simulation on Mon Apr 29 18:26:17 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './dog_laugh1_rom.sh' script.

./dog_laugh1_rom.sh -reset_run
...
./dog_laugh1_rom.sh -noclean_files

For more information on the script, please type './dog_laugh1_rom.sh -help'.

...
#
# Generated by export_simulation on Thu May 02 09:58:16 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_7_rom.sh' script.

./num_7_rom.sh -reset_run
...
./num_7_rom.sh -noclean_files

For more information on the script, please type './num_7_rom.sh -help'.

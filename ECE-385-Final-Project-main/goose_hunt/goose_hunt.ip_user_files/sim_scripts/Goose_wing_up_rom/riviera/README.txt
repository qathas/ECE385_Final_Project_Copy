...
#
# Generated by export_simulation on Sun Apr 21 17:24:08 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './Goose_wing_up_rom.sh' script.

./Goose_wing_up_rom.sh -reset_run
...
./Goose_wing_up_rom.sh -noclean_files

For more information on the script, please type './Goose_wing_up_rom.sh -help'.

...
#
# Generated by export_simulation on Thu May 02 09:55:40 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_3_rom.sh' script.

./num_3_rom.sh -reset_run
...
./num_3_rom.sh -noclean_files

For more information on the script, please type './num_3_rom.sh -help'.

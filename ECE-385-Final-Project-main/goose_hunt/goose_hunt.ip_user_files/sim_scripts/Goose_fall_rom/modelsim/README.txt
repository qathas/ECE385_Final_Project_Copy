...
#
# Generated by export_simulation on Tue Apr 23 20:02:42 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './Goose_fall_rom.sh' script.

./Goose_fall_rom.sh -reset_run
...
./Goose_fall_rom.sh -noclean_files

For more information on the script, please type './Goose_fall_rom.sh -help'.

...
#
# Generated by export_simulation on Thu May 02 09:54:11 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_2_rom.sh' script.

./num_2_rom.sh -reset_run
...
./num_2_rom.sh -noclean_files

For more information on the script, please type './num_2_rom.sh -help'.

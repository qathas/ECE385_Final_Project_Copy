...
#
# Generated by export_simulation on Thu May 02 09:52:44 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_0_rom.sh' script.

./num_0_rom.sh -reset_run
...
./num_0_rom.sh -noclean_files

For more information on the script, please type './num_0_rom.sh -help'.

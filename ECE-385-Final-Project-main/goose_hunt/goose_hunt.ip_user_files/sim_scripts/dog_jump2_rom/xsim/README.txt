...
#
# Generated by export_simulation on Fri Apr 26 09:11:50 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './dog_jump2_rom.sh' script.

./dog_jump2_rom.sh -reset_run
...
./dog_jump2_rom.sh -noclean_files

For more information on the script, please type './dog_jump2_rom.sh -help'.

...
#
# Generated by export_simulation on Thu May 02 09:59:21 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_9_rom.sh' script.

./num_9_rom.sh -reset_run
...
./num_9_rom.sh -noclean_files

For more information on the script, please type './num_9_rom.sh -help'.

...
#
# Generated by export_simulation on Thu May 02 09:53:32 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_1_rom.sh' script.

./num_1_rom.sh -reset_run
...
./num_1_rom.sh -noclean_files

For more information on the script, please type './num_1_rom.sh -help'.

...
#
# Generated by export_simulation on Thu May 02 10:10:42 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './duck_hunt_v2_rom.sh' script.

./duck_hunt_v2_rom.sh -reset_run
...
./duck_hunt_v2_rom.sh -noclean_files

For more information on the script, please type './duck_hunt_v2_rom.sh -help'.

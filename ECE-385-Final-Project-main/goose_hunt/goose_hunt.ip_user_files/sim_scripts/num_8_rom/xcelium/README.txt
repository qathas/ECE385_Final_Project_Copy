...
#
# Generated by export_simulation on Thu May 02 09:58:50 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_8_rom.sh' script.

./num_8_rom.sh -reset_run
...
./num_8_rom.sh -noclean_files

For more information on the script, please type './num_8_rom.sh -help'.

...
#
# Generated by export_simulation on Mon Apr 29 18:35:56 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './Goose_fly_away1_rom.sh' script.

./Goose_fly_away1_rom.sh -reset_run
...
./Goose_fly_away1_rom.sh -noclean_files

For more information on the script, please type './Goose_fly_away1_rom.sh -help'.

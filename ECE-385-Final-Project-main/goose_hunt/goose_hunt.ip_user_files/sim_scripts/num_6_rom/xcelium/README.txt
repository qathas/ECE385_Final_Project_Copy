...
#
# Generated by export_simulation on Thu May 02 09:57:43 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './num_6_rom.sh' script.

./num_6_rom.sh -reset_run
...
./num_6_rom.sh -noclean_files

For more information on the script, please type './num_6_rom.sh -help'.

...
HD_PWD='C:/385_Vivado_Projects/Final_Project/ECE-385-Final-Project/goose_hunt/goose_hunt.runs/dog_jump2_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dog_jump2_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dog_jump2_rom.tcl

...
HD_PWD='C:/385_Vivado_Projects/Final_Project/ECE-385-Final-Project/goose_hunt/goose_hunt.runs/Goose_fly_away3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Goose_fly_away3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Goose_fly_away3.tcl
